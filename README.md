...
📊 Interactive Charts: Line and bar charts for malaria cases and deaths by country and year.

🗺️ Choropleth Map: Visualize malaria impact across Africa with color-coded maps.

📈 Summary Statistics: Quick overview of malaria trends over time.
...
Dataset: Malaria in Africa (2007–2017) – Kaggle
